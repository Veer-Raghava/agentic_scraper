...
# Legacy aliases expected by some scraper_agent variants
def extract_tables_from_pdf(pdf_path: str) -> list[list[list[str]]]:
    """Backward-compatible alias for extract_pdf_tables."""
    return extract_pdf_tables(pdf_path)


def extract_text_from_pdf(pdf_path: str) -> str:
    """Backward-compatible alias for extract_pdf_text."""
